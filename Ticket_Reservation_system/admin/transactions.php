...
<html>
  ...
  <body>
    <div class="ui inverted huge borderless fixed fluid menu">
      <a class="header item">THE ROYAL ROUTE</a>
      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="item" href="bookings.php">Bookings</a><a class="item active" href="transactions.php">Transactions</a><!--<a class="item" href=""><a class="item" href=""></a><a class="item"></a>
-->
          </div>
        </div>
