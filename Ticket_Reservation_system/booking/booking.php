...
<body>
    <div class="ui inverted huge borderless fixed fluid menu">
      <a class="header item">WELCOME TO THE ROYAL ROUTE</a>
    </div><br>
...
<div class="ui unstackable tiny steps">
  <div class="step" onclick="booking()">
    ...
    <div class="content">
      ...
      <div class="description">Place to be visit info</div>
    </div>
  </div>
...
<form class="ui form attached fluid loading segment" onsubmit="return contact(this)">
   <div class="field">
    <label>Select your preferable time of visiting</label>
 <div class="field">
    <select required id="destination">
      <option value="" selected disabled>--Time of visiting--</option>
      <option>Between 9 am to 11 am</option>
      <option>Between 11 am to 1 pm</option>
	   <option>Between 3 pm to 5 pm</option>
	    <option>Between 5 pm to 7 pm</option>
    </select>
  </div>   
  </div>
<div class="field">  
    <label>Ticket Class</label><span></span>
 <div class="field">
    <select name="gender" required id="travelclass">
      <option value="" selected disabled>--Ticket Class--</option>
      <option>VIP Ticket</option>
      <option>Middle Class Ticket</option>
	   <option>Lower Class Ticket</option>
	  <!--  <option>Special Needs Ticket</option>-->
    </select>
  </div>   
  </div>
...
<input placeholder="Number of Seats" type="number" id="seats" min="1" max="72"   required>
  </div> 
<div class="field"> 
...
<div class="ui attached message">
  <div class="header">Enter Customer Details! </div>
   <div class="header">Order Ref: <span style="color:red;font-size:15px"><?php echo $_SESSION['ORDERREF']?> <a href='index.php'> Cancel Order</a></span> </div>
...
<form class="ui form attached fluid loading segment" onsubmit="return billing(this)">
  ...
  <div class="field">
    ...
    <input placeholder="contact no" type="tel" id="phone" name="phone" pattern="[0-9]{10}">
  </div>
